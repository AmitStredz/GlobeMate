...
export default function LocalHostOnboarding() {
  ...
  // Debug KYC state changes
  useEffect(() => {
    console.log('KYC Completed state changed:', kycCompleted);
  }, [kycCompleted]);
  ...
  const handleFinalSubmission = async () => {
    ...
    try {
      ...
      // Refresh user data to get updated local host status
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      ...
      case 3:
        return <KYCVerificationStep data={localHostData} onVerify={handleKYCVerification} isVerifying={kycVerifying} kycCompleted={kycCompleted} />;
      default:
        return <PersonalDetailsStep data={localHostData} setData={setLocalHostData} errors={errors} />;
    }
  };
